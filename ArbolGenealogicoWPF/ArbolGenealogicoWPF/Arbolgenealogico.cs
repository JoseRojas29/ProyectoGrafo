        ...
        public bool AgregarNodo(string cedulaReferencia, MiembroFamilia nuevo, string tipoRelacion)
        {
            ...
            switch (tipoRelacion)
            {
                ...
                case "descendiente":
                    ...
                    // Copiamos los padres del miembro de referencia, si existen,
                    // usando los métodos públicos de MiembroFamilia.
                    if (refMiembro.Padre != null)
                        nuevo.AsignarPadre(refMiembro.Padre);

                    if (refMiembro.Madre != null)
                        nuevo.AsignarMadre(refMiembro.Madre);
        ...
        public int[,] GenerarMatriz(List<MiembroFamilia> miembros)
        {
            ...
            foreach (var miembro in miembros)
            {
                ...
                foreach (var hijo in miembro.Hijos)
                {
                    ...
                    matriz[i, j] = 2; // ascendente → descendiente
                    matriz[j, i] = 4; // descendiente → ascendente
                }
            }
